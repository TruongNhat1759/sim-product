                        ...
                        <div className="row">
                            <div className="col-xl-4">
                                <div className="foo-info">
                                    <p className="foo-logo"><a href="/"><img src={ require('../../assets/footer_logo.png') } /></a></p>
                            ...
                            <div className="col-xl-2">
                                ...
                                <div className="foo-img">
                                    <p><a href="http://online.gov.vn/" target="blank"><img src={ require("../../assets/footer_img01.png") } /></a></p>
                                    <p><a href="http://online.gov.vn/" target="blank"><img src={ require("../../assets/footer_img02.png") } /></a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <p id="totop" onClick={() => this.scrollToTop()} className={is_visible && ("show")}><img src={require('../../assets/totop.png')} alt="to top" /></p>
