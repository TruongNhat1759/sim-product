                ...
                <div className="main-right col-xl-4">
                    ...
                    <div className="under-section">
                        <ul className="under-banner">
                            <li><a href="#"><img src={require("../../assets/idx_banner01.jpg")} /></a></li>
                            <li><a href="#"><img src={require("../../assets/idx_banner02.png")} /></a></li>
                            <li><a href="#"><img src={require("../../assets/idx_banner03.png")} /></a></li>
                            <li><a href="#"><img src={require("../../assets/idx_banner04.png")} /></a></li>
                        </ul>
                    </div>
                    <div className="under-section">
